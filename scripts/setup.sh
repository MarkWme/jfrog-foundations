...
if jf rt ping --server-id "${SERVER_ID}"; then
    ...
    echo "    - The password is the one from the handout, and you may have"
    echo "      been asked to change it on first sign-in to the web UI. If you"
    echo "      changed it, use the new one."
